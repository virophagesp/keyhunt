default:
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Ofast -ftree-vectorize -c bloom/bloom.cpp -o bloom.o
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Ofast -ftree-vectorize -c base58/base58.c -o base58.o
	...
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Ofast -ftree-vectorize -c secp256k1/IntGroup.cpp -o IntGroup.o
	...
	g++ -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Ofast -ftree-vectorize -o keyhunt keyhunt.cpp base58.o hash/ripemd160.o hash/ripemd160_sse.o hash/sha256.o hash/sha256_sse.o bloom.o util.o Int.o Point.o SECP256K1.o IntMod.o Random.o IntGroup.o -lm -lpthread
	rm -r *.o */*.o
clean:
	rm -f keyhunt
run:

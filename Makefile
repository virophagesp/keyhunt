...
clean:
	rm keyhunt
run_small_test:
	./keyhunt -f 16.txt -l compress -r 8000:ffff -n 0x100000
run_medium_test:
	./keyhunt -f 34.txt -l compress -r 200000000:3ffffffff -n 0x100000
run_big_test:
	./keyhunt -f 69.txt -l compress -r 100000000000000000:1fffffffffffffffff -n 0x100000
run_money:
	./keyhunt -f 82.txt -l compress -r 200000000000000000000:3ffffffffffffffffffff -n 0x100000
